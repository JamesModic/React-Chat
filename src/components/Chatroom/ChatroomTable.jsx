...
const ChatroomTable = (props) => {
  ...
  //! This is the table that pulls the chatroom information from the database to display for user to view. here they can pick a chatroom to enter and begin posting messages. they can also delete the chatroom from this table as well
  return (
    <>
      <Table striped>
        <thead>
