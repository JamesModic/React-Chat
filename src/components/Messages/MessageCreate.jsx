...
const MessageCreate = (props) => {
  ...
  //! Input field where user enters information to create a new message. the user can add details to these messages such as the message, who added the message, and what time it was submitted at, then the user just has to hit the button "create message" to post the message to the chatroom
  return (
    <>
